        ...
        <div className="checkout-page">
          <div className="checkout-container" style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', paddingTop: '60px' }}>
            ...
            <p style={{ color: '#6B7280', marginTop: 12, lineHeight: 1.6 }}>
              ...
              You will get access to the AI Scanner once approved.
            </p>
            <div style={{ marginTop: 24, color: '#9CA3AF', fontSize: 14 }}>Redirecting to My Requests...</div>
          </div>
        </div>
      </PageTransition>
    );
        ...
        <div className="checkout-container">
          <motion.div className="order-summary" initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }}>
            ...
            <div className="plan-summary-card">
              ...
              <h3>AI Scanner Subscription</h3>
              <span className="category" style={{ background: '#EDE9FE', color: '#6D28D9' }}>Yearly Access</span>
              <p style={{ color: '#6B7280', fontSize: '14px', marginTop: '8px' }}>
                Get full access to the AI Food Scanner. Upload any meal photo and receive instant nutritional analysis.
              </p>
              <div className="summary-details">
                <div className="summary-item">
                  ...
                  <div>
                    ...
                    <span className="value">AI Food Scanner</span>
                  </div>
                </div>
                <div className="summary-item">
                  <Clock size={18} />
