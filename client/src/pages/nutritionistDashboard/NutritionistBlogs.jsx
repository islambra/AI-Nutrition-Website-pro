...
import './NutritionistBlogs.css';

const NutritionistBlogs = () => {
  ...
  if (loading) return (
    <div className="nutritionist-blogs-loading">
  ...
  if (error) return (
    <div className="nutritionist-blogs-error">
...
export default NutritionistBlogs;