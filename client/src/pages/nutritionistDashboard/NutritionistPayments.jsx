...
import { getNutritionistPlanPayments } from '../../api/paymentApi';
import { User, Package, Calendar, CreditCard, TrendingUp, DollarSign, Users } from 'lucide-react';
import './NutritionistPayments.css';
...
const NutritionistPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      setLoading(true);
      const res = await getNutritionistPlanPayments();
  ...
  return (
    <div className="nutritionist-payments-container">
      {/* Header with stats */}
