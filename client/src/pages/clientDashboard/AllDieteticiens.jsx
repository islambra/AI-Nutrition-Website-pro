...
const Icons = {
  ...
  MessageCircle: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
  ClipboardList: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="14" y2="13"/><line x1="8" y1="17" x2="12" y2="17"/></svg>,
          ...
          filtered.map((d, i) => (
            <ScrollReveal key={d._id} direction={i % 2 === 0 ? "left" : "right"}>
              ...
              >
                ...
                {/* Benefits Strip */}
                <div className="aff-benefits-strip">
                  <span className="aff-benefit-item">
                    <Icons.Video />
                    {t('dashboard.client.benefitZoom')}
                  </span>
                  <span className="aff-benefit-item">
                    <Icons.MessageCircle />
                    {t('dashboard.client.benefitChat')}
                  </span>
                  <span className="aff-benefit-item">
                    <Icons.ClipboardList />
                    {t('dashboard.client.benefitDiary')}
                  </span>
                  <span className="aff-benefit-item">
                    <Icons.FileText />
                    {t('dashboard.client.benefitResources')}
                  </span>
                </div>
